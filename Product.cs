...
namespace _01electronics_crm
{
    public class Product
    {
        ...
        protected String productphotoLocalPath;
        protected String productphotoServerPath;
 ...
 //       }
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public bool DownloadPhotoFromServer(string photoServerPath,string photoLocalPath)
        {
        ...
        public bool UploadPhotoToServer(string photoServerPath,string photoLocalPath)
        {
        ...
        //↓↓↓↓↓↓↓↓↓↓↓↓ Added By Raouf ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
        public bool DeletePhotoFromServer(string photoServerPath)
        {
        ...
        //}
        //
        public void SetProductPhotoLocalPath(String mPath)
        {
            productphotoLocalPath = mPath;
        }


        public void SetProductPhotoServerPath(String mPath)
        {
            productphotoServerPath = mPath;
        }
        ...
        //}
        public String GetProductPhotoServerPath()
        {
            return productphotoServerPath;
        }
        ...
        {
            productphotoServerPath = String.Empty;
            productphotoServerPath += BASIC_MACROS.MODELS_PHOTOS_PATH;
            productphotoServerPath += "products/";
        ...
        {
            productphotoLocalPath = String.Empty;
            productphotoLocalPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\01Electronics_ERP\\products\\" + GetProductID() + ".jpg";
            return productphotoLocalPath;
        }
        ...
        {
            productphotoLocalPath = String.Empty;
            productphotoLocalPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\01Electronics_ERP\\products";
            return productphotoLocalPath;
        }
