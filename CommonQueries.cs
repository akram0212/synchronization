...
namespace _01electronics_erp
{
    public class CommonQueries
    {
        ...
        public bool GetAllStates(ref List<BASIC_STRUCTS.STATE_STRUCT> returnVector)
        {
            returnVector.Clear();

            String sqlQueryPart1 = @"select states_governorates.id, states_governorates.state_governorate 
                                    from erp_system.dbo.states_governorates
                                    order by states_governorates.state_governorate; ";
        ...
        public bool GetAllCities(ref List<BASIC_STRUCTS.CITY_STRUCT> returnVector)
        {
            returnVector.Clear();

            String sqlQueryPart1 = @"select cities.id, cities.city from erp_system.dbo.cities
        ...
        public bool GetAllDistricts(ref List<BASIC_STRUCTS.DISTRICT_STRUCT> returnVector)
        {
            returnVector.Clear();

            String sqlQueryPart1 = @"select id, district from erp_system.dbo.districts
                                        order by district;";
