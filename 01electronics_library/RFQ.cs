...
namespace _01electronics_library
{
    public class RFQ
    {
        ...
        public RFQ()
        {
            ...
            RFQIdString = new char[BASE_RFQ_ID_LENGTH];
            revisedRFQIdString = new char[REVISED_RFQ_ID_LENGTH];
        ...
        public void GetNewRFQID()
        {
            ...
            for (int i = 0; i < rfqDateID.Length - 1; i++)
            {
        ...
        //////////////////////////////////////////////////////////////////////
        ///
        protected bool InsertIntoRFQs()
        {
            String sqlQueryPart1 = "insert into erp_system.dbo.rfqs values (getdate(), ";
            String sqlQueryPart2 = "');";
            ...
            sqlQuery += comma;
            sqlQuery += GetRFQProduct1TypeId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct1BrandId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct1ModelId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct1Quantity();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct2TypeId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct2BrandId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct2ModelId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct2Quantity();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct3TypeId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct3BrandId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct3ModelId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct3Quantity();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct4TypeId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct4BrandId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct4ModelId();
            sqlQuery += comma;
            sqlQuery += GetRFQProduct4Quantity();
            sqlQuery += comma;
            sqlQuery += GetRFQContractTypeId();
            sqlQuery += commaApostrophe;
            sqlQuery += GetRFQDeadlineDate().ToString("yyyy-MM-dd");
            sqlQuery += apostropheComma;
            sqlQuery += GetRFQStatusId();
            sqlQuery += commaApostrophe;
            sqlQuery += GetRFQNotes();
            sqlQuery += sqlQueryPart2;
        ...
        protected bool InsertIntoUnsuccessfulRFQs()
        {
            String sqlQueryPart1 = @"insert into erp_system.dbo.unsucessful_rfqs values('";
            String comma = " ,";
            String apostropheComma = " ',";
            String commaApostrophe = " ,'";
            String apostropheCommaApostrophe = "','";
            ...
            sqlQuery += GetRFQVersion();
            sqlQuery += comma;
            sqlQuery += GetRFQFailureReasonId();
            sqlQuery += sqlQueryPart2;
        ...
        //UPDATE FUNCTIONS
        //////////////////////////////////////////////////////////////////////
        protected bool UpdateRFQStatus()
        {
            String sqlQueryPart1 = @"update erp_system.dbo.rfqs
                                     set rfqs.rfq_status = ";
            String sqlQueryPart2 = " where rfqs.sales_person = ";
            String sqlQueryPart3 = " and rfqs.rfq_serial = ";
            String sqlQueryPart4 = " and rfqs.rfq_version = ";
