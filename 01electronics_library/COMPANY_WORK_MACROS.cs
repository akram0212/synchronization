...
namespace _01electronics_library
{
    ...
    {
        //WorkOffer Macros
        public const int OFFER_VIEW_CONDITION = 0;
        public const int OFFER_ADD_CONDITION = 1;
        public const int OFFER_REVISE_CONDITION = 2;
        public const int OFFER_RESOLVE_CONDITION = 3;

        //RFQ MACROS
        public const int RFQ_VIEW_CONDITION = 0;
        public const int RFQ_ADD_CONDITION = 1;
        public const int RFQ_REVISE_CONDITION = 2;
        public const int RFQ_RESOLVE_CONDITION = 3;
