...
namespace _01electronics_library
{
    public class WorkOffer : RFQ
    {
        ...
        protected Decimal percentDownPayment;
        protected Decimal percentOnDelivery;
        protected Decimal percentOnInstallation;
        ...
        public WorkOffer()
        {
            ...
            offerIdString = new char[BASE_OFFER_ID_LENGTH];
            revisedOfferIdString = new char[REVISED_OFFER_ID_LENGTH];
		...
		where work_offers.offer_proposer = ";
            ...
            for (int i = 0; i < sqlDatabase.rows.Count; i++)
            {
                ...
                OfferProductsList[i].productPrice = Convert.ToDecimal(sqlDatabase.rows[productNumber - 1].sql_money[0]);
            }
        ...
        where work_offers.offer_proposer = ";
            ...
            for (int i = 0; i < sqlDatabase.rows.Count; i++)
            {
                ...
                intColumnsCount = productNoColumn;
                StringColumnsCount = productName;
        ...
        public bool ResolveRFQ(int mSalesPerson, int mRFQSerial, int mRFQVersion)
        {
            ResetWorkOfferInfo(COMPANY_ORGANISATION_MACROS.SALES_TEAM_ID);

            if (!InitializeRFQInfo(mRFQSerial, mRFQVersion, mSalesPerson))
                return false;
        ...
        {
            return OfferProductsList[3].productPrice;
        }
        ...
        public Decimal GetPercentDownPayment()
        {
            return percentDownPayment;
        }
        public Decimal GetPercentOnDelivery()
        {
            return percentOnDelivery;
        }
        public Decimal GetPercentOnInstallation()
        {
        ...
        public bool IssueNewOffer()
        {
            ...
            if (!InsertIntoWorkOffers())
                return false;

            if (!InsertIntoWorkOffersProducts())
                return false;

            if(GetRFQSerial() != 0)
                if (!InsertIntoWorkOffersRFQs())
                    return false;
        ...
        public bool ConfirmOffer()
        {
            ...
            if (!UpdateWorkOfferStatus())
                return false;

            return true;
        }
        public bool RejectOffer(int mFailureReasonId, String mFailureReason)
        {
            ...
            if (!InsertIntoUnsuccessfulWorkOffers())
                return false;
        ...
        public void GetNewOfferID()
        {
            ...
            for (int i = 0; i < employeeInitials.Length; i++)
            {
             ...
             for (int i = 0; i < offerDateID.Length - 1; i++)
            {
        ...
        //////////////////////////////////////////////////////////////////////
        ///
        protected bool InsertIntoWorkOffers()
        {
            String sqlQueryPart1 = "insert into erp_system.dbo.work_offers values ('";
            String sqlQueryPart2 = "');";
            ...
            sqlQuery = String.Empty;
            sqlQuery += sqlQueryPart1;
            sqlQuery += GetOfferIssueDate().ToString("yyyy-MM-dd");
            sqlQuery += apostropheComma;
            sqlQuery += GetOfferProposerId();
            sqlQuery += comma;
            sqlQuery += GetOfferSerial();
            sqlQuery += comma;
            sqlQuery += GetOfferVersion();
            sqlQuery += comma;
            ...
            sqlQuery += GetOfferID();
            sqlQuery += apostropheComma;
            sqlQuery += GetCurrencyId();
            sqlQuery += commaApostrophe;
            sqlQuery += GetTotalPriceValue();
            sqlQuery += apostropheComma;
            sqlQuery += GetPercentDownPayment();
            sqlQuery += comma;
            sqlQuery += GetPercentOnDelivery();
            sqlQuery += comma;
            sqlQuery += GetPercentOnInstallation();
            sqlQuery += comma;
            if (GetHasDrawings()) 
                sqlQuery += 1;
            else
                sqlQuery += 0;
            sqlQuery += comma;
            sqlQuery += GetDeliveryTimeMinimum();
            sqlQuery += comma;
            sqlQuery += GetDeliveryTimeMaximum();
            sqlQuery += comma;
            sqlQuery += GetDeliveryTimeUnitId();
            sqlQuery += comma;
            sqlQuery += GetDeliveryPointId();
            sqlQuery += comma;
            sqlQuery += GetOfferContractTypeId();
            sqlQuery += comma;
            sqlQuery += GetWarrantyPeriod();
            sqlQuery += comma;
            sqlQuery += GetWarrantyPeriodTimeUnitId();
            sqlQuery += comma;
            sqlQuery += GetOfferValidityPeriod();
            sqlQuery += comma;
            sqlQuery += GetOfferValidityTimeUnitId();
            sqlQuery += comma;
            sqlQuery += GetOfferStatusId();
            sqlQuery += commaApostrophe;
            sqlQuery += GetOfferNotes();
            sqlQuery += sqlQueryPart2;
        ...
        protected bool InsertIntoWorkOffersProducts()
        {
            int productNumber = 1;
            for (int i = 0; i < GetNoOfOfferSavedProducts(); i++)
            {

                String sqlQueryPart1 = "insert into erp_system.dbo.work_offers_products_info values (";
                String sqlQueryPart2 = "');";
                ...
                sqlQuery += GetOfferVersion();
                sqlQuery += comma;
                sqlQuery += productNumber;
                sqlQuery += comma;
                sqlQuery += GetOfferProductTypeId(productNumber);
                sqlQuery += comma;
                sqlQuery += GetOfferProductBrandId(productNumber);
                sqlQuery += comma;
                sqlQuery += GetOfferProductModelId(productNumber);
                sqlQuery += comma;
                sqlQuery += GetOfferProductQuantity(productNumber);
                sqlQuery += comma;
                sqlQuery += GetProductPriceValue(productNumber);
                sqlQuery += commaApostrophe;
                sqlQuery += GetOfferIssueDate().ToString("yyyy-MM-dd");
                sqlQuery += sqlQueryPart2;
        ...
        protected bool InsertIntoWorkOffersDrawings()
        {
            String sqlQueryPart1 = "insert into erp_system.dbo.work_offers_drawings values (";
            String sqlQueryPart2 = "');";
            ...
            sqlQuery += GetOfferVersion();
            sqlQuery += comma;
            sqlQuery += GetDrawingSubmissionDeadlineMinimum();
            sqlQuery += comma;
            sqlQuery += GetDrawingSubmissionDeadlineMaximum();
            sqlQuery += commaApostrophe;
            sqlQuery += GetOfferIssueDate().ToString("yyyy-MM-dd");
            sqlQuery += sqlQueryPart2;
        ...
        protected bool InsertIntoWorkOffersRFQs()
        {
            String sqlQueryPart1 = "insert into erp_system.dbo.work_offers_rfqs values (";
            String sqlQueryPart2 = "');";
            ...
            sqlQuery += GetSalesPersonId();
            sqlQuery += comma;
            sqlQuery += GetRFQSerial();
            sqlQuery += comma;
            sqlQuery += GetRFQVersion();
            sqlQuery += commaApostrophe;
            sqlQuery += GetOfferIssueDate().ToString("yyyy-MM-dd");
            sqlQuery += sqlQueryPart2;
        ...
        protected bool InsertIntoUnsuccessfulWorkOffers()
        {
            String sqlQueryPart1 = @"insert into erp_system.dbo.unsucessful_work_offers values(getdate(), ";
            String comma = " ,";
            String apostropheComma = " ',";
            String commaApostrophe = " ,'";
            String apostropheCommaApostrophe = "','";
            ...
            sqlQuery += GetOfferVersion();
            sqlQuery += comma;
            sqlQuery += GetOfferFailureReasonId();
            sqlQuery += sqlQueryPart2;
        ...
        //UPDATE FUNCTIONS
        //////////////////////////////////////////////////////////////////////
        protected bool UpdateWorkOfferStatus()
        {
            String sqlQueryPart1 = @"update erp_system.dbo.work_offers
                                     set work_offers.offer_status = ";
            String sqlQueryPart2 = " where work_offers.offer_proposer = ";
            String sqlQueryPart3 = " and work_offers.offer_serial = ";
            String sqlQueryPart4 = " and work_offers.offer_version = ";
