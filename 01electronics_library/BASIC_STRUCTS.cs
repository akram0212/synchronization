...
namespace _01electronics_library
{
    public class BASIC_STRUCTS
    {
        ...
        public struct DOCUMENT_TYPE_STRUCT
        {
            public String document_type_name;
            public int document_type_id;
        };

        public struct EDUCATIONAL_MAJOR_STRUCT
        {
            public String edu_major_name;
            public int edu_major_id;
        };
        public struct EDUCATIONAL_DEGREE_STRUCT
        {
            public String edu_degree_name;
            public int edu_degree_id;
        };
