...
namespace _01electronics_library
{
    public class IntegrityChecks
    {
        ...
        public bool CheckEmployeePhoneEditBox(String inputString, ref String outputString, bool isRequired)
        {
            RemoveExtraSpaces(inputString, ref outputString);
            ...
            if (isRequired && isEmpty)
            {
                System.Windows.Forms.MessageBox.Show("Business Phone must be specified.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
