...
namespace _01electronics_library
{
    public class Company
    {
        ...
        public bool IssueNewBranch(String Telephone, String Fax)
        {
            if (!GetNewAddressSerial())
                return false;

            if (!InsertIntoCompanyAddress())
                return false;

            if (!InsertIntoCompanyTelephone(Telephone))
                return false;

            if (!InsertIntoCompanyFax(Fax))
                return false;

            return true;
        }

        public bool GetNewDistrictId(String mDistrict)
        {
            district = mDistrict;

            /////////////////////////////////////////////////////////////////
            ///CHECK EXISTING CITY OF DISTRICT
            /////////////////////////////////////////////////////////////////

            String sqlQueryPart1 = @"select distinct cities.city 

                            from erp_system.dbo.districts 
							inner join erp_system.dbo.cities 
							on districts.city = cities.id 
							where districts.city = ";

            String sqlQueryPart2 = ";";

            sqlQuery = String.Empty;
            sqlQuery += sqlQueryPart1;
            sqlQuery += GetCompanyCityId();
            sqlQuery += sqlQueryPart2;
            ...
            {
                districtId = GetCompanyCityId() * 100;
            }
            else
            {
                /////////////////////////////////////////////////////////////////
                ...
                string sqlQueryPart3 = "select max(districts.id) from erp_system.dbo.districts where districts.city = ";
                ...
                districtId = sqlDatabase.rows[0].sql_int[0] + 1;
            }
            ...
            String sqlQueryPart5 = "insert into erp_system.dbo.districts values(";
            String sqlQueryPart6 = ",";
            String sqlQueryPart7 = ",'";
            String sqlQueryPart8 = "', getdate());";

            sqlQuery = String.Empty;
            sqlQuery += sqlQueryPart5;
            sqlQuery += GetCompanyCityId();
            sqlQuery += sqlQueryPart6;
            sqlQuery += GetCompanyDistrictId();
            sqlQuery += sqlQueryPart7;
            sqlQuery += GetCompanyDistrict();
        ...
        public bool QueryCompanyPhones()
        {
            ...
            for (int i = 0; i < sqlDatabase.rows.Count; i++)
                companyPhones.Add(sqlDatabase.rows[i].sql_string[0]);
        ...
        public bool QueryCompanyFaxes()
        {
            ...
            for (int i = 0; i < sqlDatabase.rows.Count; i++)
                companyFaxes.Add(sqlDatabase.rows[i].sql_string[0]);


            return true;
        }
        public bool InsertIntoCompanyName()
        {
            ...
            sqlQuery += sqlQueryPart2;
            sqlQuery += "'" + GetCompanyName() + "'";
            sqlQuery += sqlQueryPart2;
            sqlQuery += GetOwnerUserId();
        ...
        public bool InsertIntoCompanyWorkField()
        {
            ...
            sqlQuery += GetCompanySerial();
            sqlQuery += sqlQueryPart2;
            sqlQuery += GetCompanySecondaryFieldId();
            sqlQuery += sqlQueryPart2;
            sqlQuery += GetOwnerUserId();
        ...
        public bool InsertIntoCompanyAddress()
        {
        ...
        public bool InsertIntoCompanyTelephone(String Telephone)
        {
        ...
        public bool InsertIntoCompanyFax(String Fax)
        {
